...
### `organize` — Laptop Cleanup

Sorts Downloads, flags duplicates, organizes screenshots, and reports what was moved.
...
4. If a mistake is systemic, it updates the relevant skill file
...
- Check job state before sending HITL
...
Built by [@chethanbhatbs](https://github.com/chethanbhatbs)
